...
const US_BIG4: DJMonitorOrg[] = [
  {
    ...
    apiType: 'websearch',
    searchQuery: 'EY Ernst Young "IT Auditor" OR "Internal Audit" OR "Technology Risk" OR "CISA" Manager Director SOX ITGC site:linkedin.com OR site:ey.com 2026',
  ...
  },
  {
    ...
    sector: 'big4', country: 'USA', eadFriendly: true,
    apiType: 'websearch',
    searchQuery: 'Deloitte "IT Auditor" OR "Internal Audit" OR "Technology Risk" OR "CISA" Manager Director SOX Cloud Security site:linkedin.com OR site:deloitte.com 2026',
  ...
  },
  {
    ...
    sector: 'big4', country: 'USA', eadFriendly: true,
    apiType: 'websearch',
    searchQuery: 'KPMG "IT Auditor" OR "Internal Audit" OR "Technology Risk" OR "CISA" Manager Director SOX ITGC site:linkedin.com OR site:kpmg.com 2026',
  ...
  },
  {
    ...
    sector: 'big4', country: 'USA', eadFriendly: true,
    apiType: 'websearch',
    searchQuery: 'PwC "IT Auditor" OR "Internal Audit" OR "Technology Risk" OR "CISA" Manager Director SOX Cloud GRC site:linkedin.com OR site:pwc.com 2026',
...
const INDIA_BIG4: DJMonitorOrg[] = [
  {
    ...
    apiType: 'websearch',
    searchQuery: 'EY India GDS "IT Auditor" OR "Internal Audit" OR "Technology Risk" OR "CISA" Manager Director SOX ITGC site:linkedin.com 2026',
    careersUrl: 'https://careers.ey.com',
  },
  {
    name: 'Deloitte India',
    sector: 'big4', country: 'India', managerialGrade: true,
    apiType: 'websearch',
    searchQuery: 'Deloitte India "IT Auditor" OR "Internal Audit" OR "Technology Risk" OR "CISA" Manager Director SOX ITGC site:linkedin.com 2026',
  ...
  },
  {
    ...
    sector: 'big4', country: 'India', managerialGrade: true,
    apiType: 'websearch',
    searchQuery: 'KPMG India "IT Auditor" OR "Internal Audit" OR "Technology Risk" OR "CISA" Manager Director SOX GRC site:linkedin.com 2026',
  ...
  },
  {
    ...
    sector: 'big4', country: 'India', managerialGrade: true,
    apiType: 'websearch',
    searchQuery: 'PwC India "IT Auditor" OR "Internal Audit" OR "Technology Risk" OR "CISA" Manager Director SOX ITGC site:linkedin.com 2026',

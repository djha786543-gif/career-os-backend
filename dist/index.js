...
const schedulerDJ_1 = require("./opportunity-monitor/schedulerDJ");
...
app.listen(PORT, '0.0.0.0', async () => {
    ...
    (0, schedulerDJ_1.initMonitorSchedulerDJ)().catch(err => console.error('[MonitorDJ] Scheduler init failed:', err.message));
});
